            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Daftar Surat Keterangan Usaha</p>
                    </div>
                    <div class="card-body">
                        <!-- <div class="row">
                                    ...
                                    @foreach($usaha as $post)
                                        <tr class="item{{$post->id}}">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" data-id="{{$post->id}}" data-nik="{{$post->nik}}" href="{{route('cetakusaha', ['id' => $post->id])}}">
